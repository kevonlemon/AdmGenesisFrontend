...
export const PATH_OPSISTEMA = {
  root: ROOTS_SISTEMA,
  inicio: path(ROOTS_SISTEMA, '/ajusteprecio'),
  invetario: {
    ajusteprecio: path(ROOTS_SISTEMA, '/inventario/ajusteprecio'),
    categoria: path(ROOTS_DASHBOARD, '/categoria'),
  },
  reportes: {
  ...
  procesos: {
    ...
    contratoempleado: path(ROOTS_SISTEMA, '/contratoempleado'),
  },
};
