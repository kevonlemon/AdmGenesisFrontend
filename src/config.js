...
export const PATH_AFTER_LOGIN = '/sistema/inventario/mmarca'; // as '/dashboard/app' PATH_OPSISTEMA.invetario.ajusteprecio
...
// SESION
export const usuario = JSON.parse(window.localStorage.getItem('usuario'))
